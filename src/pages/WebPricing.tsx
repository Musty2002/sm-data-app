...
const dataPrices = [
  { network: 'MTN', plans: [
    { data: '500MB', price: '', validity: '30 days' },
    { data: '1GB', price: '', validity: '30 days' },
    { data: '2GB', price: '', validity: '30 days' },
    { data: '3GB', price: '', validity: '30 days' },
    { data: '5GB', price: '', validity: '30 days' },
  ]},
