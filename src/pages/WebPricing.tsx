...
const dataPrices = [
  { network: 'MTN', plans: [
    { data: '500MB', price: '₦155', validity: '30 days' },
    { data: '1GB', price: '₦285', validity: '30 days' },
    { data: '2GB', price: '₦570', validity: '30 days' },
    { data: '3GB', price: '₦855', validity: '30 days' },
    { data: '5GB', price: '₦1,425', validity: '30 days' },
  ]},
  { network: 'Airtel', plans: [
    { data: '500MB', price: '₦150', validity: '30 days' },
    { data: '1GB', price: '₦275', validity: '30 days' },
    { data: '2GB', price: '₦550', validity: '30 days' },
    { data: '3GB', price: '₦825', validity: '30 days' },
    { data: '5GB', price: '₦1,375', validity: '30 days' },
  ]},
  { network: 'Glo', plans: [
    { data: '500MB', price: '₦145', validity: '30 days' },
    { data: '1GB', price: '₦265', validity: '30 days' },
    { data: '2GB', price: '₦530', validity: '30 days' },
    { data: '3GB', price: '₦795', validity: '30 days' },
    { data: '5GB', price: '₦1,325', validity: '30 days' },
  ]},
  { network: '9Mobile', plans: [
    { data: '500MB', price: '₦130', validity: '30 days' },
    { data: '1GB', price: '₦240', validity: '30 days' },
